...
bool Application::empty() const noexcept
{
	return m_eventsPool.empty();
}

Core::Brush* Application::entity() const noexcept
{
	return m_pBrush;
}
...
Core::Event* Application::getFrontEvent() const noexcept
{
	return m_eventsPool.front();
}

void Application::popFrontEvent() noexcept
{
	m_eventsPool.pop_front();
}
